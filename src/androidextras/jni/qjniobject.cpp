...
/*!
    ...
    \list
    \li Class name strings needs to be the fully-qualified class name, for example: \b"java/lang/String".
    ...
    But in other cases you will need to supply the signature yourself and it is important that the
    signature matches the function you want to call. The signatures are written as \b \(A\)R, where \b A
    is the argument\(s\) and \b R is the return type.
    Any types in the signature that are arrays needs to be prepended with \b\[, in addition
    fully-qualified types needs to be surrounded with \b L and \b ; to mark the start and end respectively.

    The example below demonstrates how to call two different static functions.
    \code
    // Java class
    package org.my.custom.clazz;
    class MyJavaClass
    {
    ...
    \code
    // C++ code
    QJNIObject stringNumber = QJNIObject::callStaticObjectMethod("org/my/custom/clazz",
                                                                 "fromNumber"
                                                                 "(I)Ljava/lang/String;",
                                                                 10);
    \endcode
    ...
    QJNIObject stringArray = QJNIObject::callStaticObjectMethod("org/my/custom/clazz",
                                                                "stringArray"
    ...
    \section1 The lifetime of Java Objects

    All objects returned as a result from calling a Java method through the Java Native Interface is
    by default a local references and will only stay valid in the scope the function was called.
    When exiting the scope, the object becomes eligible for garbage collection. If you want to keep
    the object alive you need to either create a new global reference to the object and release it when
    you are done or construct a new QJNIObject and let it manage the lifetime of the Java object.
    ...
    \row
        \li jobject
        \li Lyour/java/Object;
    \row
        \li jclass
        \li Lyour/java/Class;
    \row
        \li jstring
        \li Lyour/java/String;
    \row
        \li jobjectArray
        \li [Lyour/java/Object;
    \row
