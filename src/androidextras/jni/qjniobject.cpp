...
/*!
    ...
    will only stay valid in the scope it was returned in, afther that the object becomeseligible for
    garbage collection. If you want to keep the jobject alive you need to either create a new global
